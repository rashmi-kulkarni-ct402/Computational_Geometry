...
Geometry::GeomVector Utility::UserInput::vector1() const
{
    return mVector1;
}

Geometry::GeomVector Utility::UserInput::vector2() const
{
    return mVector2;
}

Geometry::GeomVector Utility::UserInput::normalVector() const
{
    return mNormalVector;
}

Geometry::Point3D Utility::UserInput::point() const
{
    return mPoint;
}

double Utility::UserInput::vectorLength() const
{
    return mVectorLength;
}

double Utility::UserInput::scalarValue() const
{
    return mScalarValue;
}

LinearAlgebra::Matrix Utility::UserInput::matrix() const
{
    return mMatrix;
}

int Utility::UserInput::axisChoice() const
{
    return mAxisChoice;
}
