...
Geometry::Vector3D Utility::UserInput::vector1()
{
    return mVector1;
}

Geometry::Vector3D Utility::UserInput::vector2()
{
    return mVector2;
}

Geometry::Vector3D Utility::UserInput::normalVector()
{
...
void Utility::UserInput::askVector1()
{
    ...
    std::cin >> x >> y >> z;
    Geometry::Vector3D vector(x, y, z);
    mVector1 = vector;
