...
int main()
{
    ...
    std::cout << "---------------------------------------------------" << std::endl;
    std::vector<Geometry::GeomVector> vectorsList;
    ...
    do
    {
        ...
        case 3:
        {
            ...
            Geometry::GeomVector normalizedVector = userInput.vector1().normalize();
        ...
        case 4:
        {
            ...
            Geometry::GeomVector newVector = userInput.vector1().setVectorLength(userInput.vectorLength());
        ...
        case 5:
        {
            ...
            Geometry::GeomVector resultVector = userInput.vector1().addScalar(userInput.scalarValue());
        ...
        case 6:
        {
            ...
            userInput.askScalarValue();
            Geometry::GeomVector resultVector = userInput.vector1().subtractScalar(userInput.scalarValue());
        ...
        case 7:
        {
            ...
            userInput.askScalarValue();
            Geometry::GeomVector resultVector = userInput.vector1().multiplyScalar(userInput.scalarValue());
        ...
        case 8:
        {
            ...
            userInput.askScalarValue();
            Geometry::GeomVector resultVector = userInput.vector1().divideScalar(userInput.scalarValue());
        ...
        case 9:
        {
            ...
            userInput.askVector2();
            Geometry::GeomVector resultVector = userInput.vector1().addVector(userInput.vector2());
        ...
        case 11:
        {
            ...
            userInput.askVector2();
            Geometry::GeomVector resultVector = userInput.vector1().crossProduct(userInput.vector2());
        ...
        case 13:
        {
            ...
            userInput.askMatrix();
            Geometry::GeomVector resultVector = userInput.vector1().multiplyMatrix(userInput.matrix());
        ...
        case 19:
        {
            ...
            userInput.askVector2();
            Geometry::GeomVector resultVector = userInput.vector1().projectionOnVector(userInput.vector2());
        ...
        case 20:
        {
            // projection on plane
            userInput.askNormalVector();
            Geometry::GeomVector resultVector = userInput.vector1().projectVectorOnPlane(userInput.normalVector());
